...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		mStocker = new JMenu("Stocker");
		JMenuItem mO1 = new JMenuItem("Consultation du Stock");
		mO1.addActionListener(this); // installation d'un écouteur d'action
		mStocker.add(mO1);
		JMenuItem mO2 = new JMenuItem("Ajout d'un médicament");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() instanceof JMenuItem) {
			...
			} else if (ChoixOption.equals("Consultation du Stock")) {
